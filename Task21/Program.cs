...
переписал спец для Андрея преподавателя, чтобы поставил оценку и я пошел дальше!!!
писал чисто по лекции, но программа не работает! а в критериях оценки написано что этого достаточно на оценку 3!
